...
Shader "Amplify/Nature/Tree Creator Leaves Optimized"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_MainColor("Main Color", Color) = (1,1,1,0)
		_TranslucencyColor("Translucency Colour", Color) = (1,1,1,0)
		_AlphaCutoff("Alpha Cutoff", Range( 0 , 1)) = 0.5
		_Smoothness("Smoothness", Range( 0 , 1)) = 0.1
		_ShadowStrength("Shadow Strength", Range( 0 , 1)) = 0.5
		_ShadowOffsetScale("Shadow Offset Scale", Float) = 1
		_BaseRBGAlphaA("Base (RBG) Alpha (A)", 2D) = "white" {}
		_ShadowRGB("Shadow (RGB)", 2D) = "white" {}
		_NormalGASpecRShadowOffsetB("Normal(GA) Spec (R) Shadow Offset (B)", 2D) = "white" {}
		_TransBGlossRougthA("Trans (B) Gloss/Rougth(A)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _ShadowRGB_ST;
			float _ShadowOffsetScale;
			float4 _NormalGASpecRShadowOffsetB_ST;
			float4 _BaseRBGAlphaA_ST;
			float4 _TransBGlossRougthA_ST;
			float _Smoothness;
			...
			CBUFFER_END
			sampler2D _ShadowRGB;
			sampler2D _NormalGASpecRShadowOffsetB;
			sampler2D _BaseRBGAlphaA;
			sampler2D _TransBGlossRougthA;
						...
						)
			{
				...
				float2 uv_ShadowRGB = packedInput.ase_texcoord5.xy * _ShadowRGB_ST.xy + _ShadowRGB_ST.zw;
				float2 uv_NormalGASpecRShadowOffsetB = packedInput.ase_texcoord5.xy * _NormalGASpecRShadowOffsetB_ST.xy + _NormalGASpecRShadowOffsetB_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecRShadowOffsetB, uv_NormalGASpecRShadowOffsetB );
				float2 uv_BaseRBGAlphaA = packedInput.ase_texcoord5.xy * _BaseRBGAlphaA_ST.xy + _BaseRBGAlphaA_ST.zw;
				float4 tex2DNode13 = tex2D( _BaseRBGAlphaA, uv_BaseRBGAlphaA );
				
				float4 appendResult19 = (float4(tex2DNode14.g , tex2DNode14.a , 0.0 , 0.0));
				
				float2 uv_TransBGlossRougthA = packedInput.ase_texcoord5.xy * _TransBGlossRougthA_ST.xy + _TransBGlossRougthA_ST.zw;
				float4 tex2DNode15 = tex2D( _TransBGlossRougthA, uv_TransBGlossRougthA );
				
				surfaceDescription.Albedo = ( _MainColor * ( ( _ShadowStrength * ( tex2D( _ShadowRGB, uv_ShadowRGB ).r * ( _ShadowOffsetScale * tex2DNode14.b ) ) ) + tex2DNode13 ) ).rgb;
				surfaceDescription.Normal = appendResult19.xyz;
				...
				#if defined( _MATERIAL_FEATURE_SUBSURFACE_SCATTERING ) || defined( _MATERIAL_FEATURE_TRANSMISSION )
				surfaceDescription.DiffusionProfile = ( tex2DNode15.b * _TranslucencyColor ).r;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ShadowRGB = packedInput.ase_texcoord.xy * _ShadowRGB_ST.xy + _ShadowRGB_ST.zw;
				float2 uv_NormalGASpecRShadowOffsetB = packedInput.ase_texcoord.xy * _NormalGASpecRShadowOffsetB_ST.xy + _NormalGASpecRShadowOffsetB_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecRShadowOffsetB, uv_NormalGASpecRShadowOffsetB );
				float2 uv_BaseRBGAlphaA = packedInput.ase_texcoord.xy * _BaseRBGAlphaA_ST.xy + _BaseRBGAlphaA_ST.zw;
				float4 tex2DNode13 = tex2D( _BaseRBGAlphaA, uv_BaseRBGAlphaA );
				
				float4 appendResult19 = (float4(tex2DNode14.g , tex2DNode14.a , 0.0 , 0.0));
				
				float2 uv_TransBGlossRougthA = packedInput.ase_texcoord.xy * _TransBGlossRougthA_ST.xy + _TransBGlossRougthA_ST.zw;
				float4 tex2DNode15 = tex2D( _TransBGlossRougthA, uv_TransBGlossRougthA );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BaseRBGAlphaA = packedInput.ase_texcoord1.xy * _BaseRBGAlphaA_ST.xy + _BaseRBGAlphaA_ST.zw;
				float4 tex2DNode13 = tex2D( _BaseRBGAlphaA, uv_BaseRBGAlphaA );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_NormalGASpecRShadowOffsetB = packedInput.ase_texcoord3.xy * _NormalGASpecRShadowOffsetB_ST.xy + _NormalGASpecRShadowOffsetB_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecRShadowOffsetB, uv_NormalGASpecRShadowOffsetB );
				float4 appendResult19 = (float4(tex2DNode14.g , tex2DNode14.a , 0.0 , 0.0));
				
				float2 uv_TransBGlossRougthA = packedInput.ase_texcoord3.xy * _TransBGlossRougthA_ST.xy + _TransBGlossRougthA_ST.zw;
				float4 tex2DNode15 = tex2D( _TransBGlossRougthA, uv_TransBGlossRougthA );
				
				float2 uv_BaseRBGAlphaA = packedInput.ase_texcoord3.xy * _BaseRBGAlphaA_ST.xy + _BaseRBGAlphaA_ST.zw;
				float4 tex2DNode13 = tex2D( _BaseRBGAlphaA, uv_BaseRBGAlphaA );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ShadowRGB = packedInput.ase_texcoord7.xy * _ShadowRGB_ST.xy + _ShadowRGB_ST.zw;
				float2 uv_NormalGASpecRShadowOffsetB = packedInput.ase_texcoord7.xy * _NormalGASpecRShadowOffsetB_ST.xy + _NormalGASpecRShadowOffsetB_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecRShadowOffsetB, uv_NormalGASpecRShadowOffsetB );
				float2 uv_BaseRBGAlphaA = packedInput.ase_texcoord7.xy * _BaseRBGAlphaA_ST.xy + _BaseRBGAlphaA_ST.zw;
				float4 tex2DNode13 = tex2D( _BaseRBGAlphaA, uv_BaseRBGAlphaA );
				
				float4 appendResult19 = (float4(tex2DNode14.g , tex2DNode14.a , 0.0 , 0.0));
				
				float2 uv_TransBGlossRougthA = packedInput.ase_texcoord7.xy * _TransBGlossRougthA_ST.xy + _TransBGlossRougthA_ST.zw;
				float4 tex2DNode15 = tex2D( _TransBGlossRougthA, uv_TransBGlossRougthA );
...
/*ASEBEGIN
Version=18000
-957;0;957;1017;969.5322;741.8239;1.101353;True;False
Node;AmplifyShaderEditor.SamplerNode;14;-952.176,-28.43348;Inherit;True;Property;_NormalGASpecRShadowOffsetB;Normal(GA) Spec (R) Shadow Offset (B);8;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;26;-860.4096,-220.3419;Inherit;False;Property;_ShadowOffsetScale;Shadow Offset Scale;5;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-618.0519,-166.7227;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;16;-932.2412,-475.666;Inherit;True;Property;_ShadowRGB;Shadow (RGB);7;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-470.8334,-360.9359;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-498.937,-578.6194;Inherit;False;Property;_ShadowStrength;Shadow Strength;4;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-229.8774,-358.7828;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;-464.4096,-186.6853;Inherit;True;Property;_BaseRBGAlphaA;Base (RBG) Alpha (A);6;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;33;-369.999,368.7645;Inherit;False;Property;_TranslucencyColor;Translucency Colour;1;0;Create;False;0;0;False;0;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;30;-149.999,-588.2355;Inherit;False;Property;_MainColor;Main Color;0;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;-426.6073,540.6947;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;False;0;0.1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-43.60531,-237.4611;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;15;-459.0129,171.756;Inherit;True;Property;_TransBGlossRougthA;Trans (B) Gloss/Rougth(A);9;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-37.6073,308.6947;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-33.29285,429.4343;Inherit;False;Property;_AlphaCutoff;Alpha Cutoff;2;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;19;-296.0129,24.75604;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;95.00098,-355.2355;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-103.999,215.7645;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;0;21;32;0
ASEEND*/
//CHKSM=06D82E9FEE2B3652B2A8BF2E253C430C16B391F9