...
Shader "Amplify/Nature/Tree Creator Bark Optimized"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _NormalGASpecR_ST;
			float4 _SpeculairColor;
						...
						)
			{
				...
				float2 uv_NormalGASpecR = packedInput.ase_texcoord5.xy * _NormalGASpecR_ST.xy + _NormalGASpecR_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecR, uv_NormalGASpecR );
				...
				surfaceDescription.Albedo = ( _MainColor * tex2DNode13 ).rgb;
				...
				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( tex2DNode14.r * _SpeculairColor ).rgb;
				#endif
				...
				#if defined( _MATERIAL_FEATURE_SUBSURFACE_SCATTERING ) || defined( _MATERIAL_FEATURE_TRANSMISSION )
				surfaceDescription.DiffusionProfile = tex2DNode15.b;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_NormalGASpecR = packedInput.ase_texcoord.xy * _NormalGASpecR_ST.xy + _NormalGASpecR_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecR, uv_NormalGASpecR );
				float4 appendResult19 = (float4(tex2DNode14.g , tex2DNode14.a , 0.0 , 0.0));
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_NormalGASpecR = packedInput.ase_texcoord3.xy * _NormalGASpecR_ST.xy + _NormalGASpecR_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecR, uv_NormalGASpecR );
				float4 appendResult19 = (float4(tex2DNode14.g , tex2DNode14.a , 0.0 , 0.0));
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_NormalGASpecR = packedInput.ase_texcoord7.xy * _NormalGASpecR_ST.xy + _NormalGASpecR_ST.zw;
				float4 tex2DNode14 = tex2D( _NormalGASpecR, uv_NormalGASpecR );
				float4 appendResult19 = (float4(tex2DNode14.g , tex2DNode14.a , 0.0 , 0.0));
...
/*ASEBEGIN
Version=18000
-957;0;957;1017;1209.675;335.8544;1;True;False
Node;AmplifyShaderEditor.SamplerNode;15;-534.0504,179.7957;Inherit;True;Property;_TransBGlossRougthA;Trans (B) Gloss/Rougth(A);3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;33;-863.9992,162.0644;Inherit;False;Property;_SpeculairColor;Speculair Color;5;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-398.1096,-193.1853;Inherit;True;Property;_BaseRBGAlphaA;Base (RBG) Alpha (A);1;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;30;-313.799,-380.2355;Inherit;False;Property;_MainColor;Main Color;0;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;-952.176,-28.43348;Inherit;True;Property;_NormalGASpecR;Normal(GA) Spec (R);2;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;-512.9252,368.9229;Inherit;False;Property;_Smoothness;Smoothness;6;0;Create;True;0;0;False;0;0.01;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-72.69901,-278.5354;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;29.75654,189.369;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-34.19285,404.5343;Inherit;False;Property;_AlphaCutoff;Alpha Cutoff;4;0;Create;True;0;0;False;0;0.3;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-616.3992,55.06443;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;0;21;15;3
ASEEND*/
//CHKSM=24C2D1FBAA66C31E564CCE7346C1ADD347E7DD12